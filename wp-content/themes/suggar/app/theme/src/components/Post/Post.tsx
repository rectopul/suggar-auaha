...
export function Post() {
    ...
    return (
        <div className="w-full px-4 xl:px-0 py-10">
            {window.post_info && (
                <div className="w-full max-w-[1300px] mx-auto flex flex-col pb-10 border-b border-neutral-300">
                    <h2 className="text-blue-900 text-xl font-bold font-pop mx-auto text-center mb-8">
                        {window.post_info.title}
                    </h2>

                    <div className="flex-col xl:flex-row flex items-start xl:items-center">
                        <span className="flex items-center text-neutral-700 text-base font-medium font-pop">
                            <img
                                src={Calendary}
                                alt="calendar"
                                className="mr-2 mt-[-4px] w-[20px]"
                            />
                            <span>{window.post_info.date}</span>
                        </span>

                        <span className="flex items-center ml-0 xl:ml-10 text-neutral-700 text-base font-medium font-pop">
                            <img
                                src={AuthorIco}
                                alt="calendar"
                                className="mr-1 mt-[-4px] w-[25px]"
                            />
                    ...
                    <div className="w-full h-[400px] bg-zinc-300 mt-5 flex justify-center items-center overflow-hidden">
                        <figure className="w-full h-full xl:h-auto">
                            <img
                                src={window.post_info.image}
                                alt="post thumbnail"
                    ...
                    <div className="w-full flex flex-col">
                        <h2 className="text-blue-900 text-lg font-bold font-pop my-6">
                            {window.post_info.title}
                        </h2>
                        {post && (
                            <div
                                className="w-full gap-7 inline-flex flex-col text-neutral-700 text-sm font-normal font-pop"
